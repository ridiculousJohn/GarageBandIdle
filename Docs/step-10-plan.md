...
The scope-reference and gather refactor that briefly sat here as a changeset 0 is its own
build-plan step, `load-linking-plan.md` (2026-09-08), and lands before slice A.
