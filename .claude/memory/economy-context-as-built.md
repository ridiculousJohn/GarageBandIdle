...
- **Next: slice 6.** 5.6 landed (`5b8a917`) and retired the last three bare `revealFlag` fields - see [[reveal-is-a-condition]] for what it established and what it cost. See [[project-layout-and-workflow]] for the slice workflow and [[unity-headless-verify-loop]] for verification.
