...
- **Next: slice 6.** Both consolidations after 5.5 have landed: 5.6 retired the last bare `revealFlag` fields ([[reveal-is-a-condition]]) and 5.7 retired `FanSystem` ([[fan-accrual-is-production]]). See [[project-layout-and-workflow]] for the slice workflow and [[unity-headless-verify-loop]] for verification.
